...
day = '26'
tel = '15853115188'
email = 'wyjq019658@126.com' #邮箱 非常重要！
sex = '女'
mailusermailpassword = '029658'
pw = 'yxl029658*'
i = 1 #起始账号
num = 3 #一共多少单
handler = '马芳珍'
...
listnum = '003'
country = "China"
state = "Shandong"#Shaanxi
city = 'Jinan' #Taiyüan Nei Mongol Qiqihar Ordos
account_1 = 'sdyxli'#用户名 非常重要！
...
wd.find_element_by_id("user").send_keys("bjmfz001")   # 清除输入框并且输入账户
wd.find_element_by_id("password").clear()
wd.find_element_by_id("password").send_keys('mfz667788') #清除输入框并且输入密码
...
while i <= num:
    ...
    wd.find_element_by_xpath('//*[@id="wrapper-register"]/div[2]/div[2]/app-payment-method/div[2]/app-wallets-register/div[1]/div[3]/input').send_keys(700)
    time.sleep(5)
    ...
    if i - num == 1:
        insertDB(allname)
    time.sleep(5)
    wd.find_element_by_xpath('//*[@id="wrapper-register"]/div[2]/div[2]/app-payment-method/app-register-success/div/button').click()
    wd.find_element_by_xpath('/html/body/app-root/app-backoffice/div/app-modal/div/i').click()
    time.sleep(2)
    # wd.find_element_by_xpath('//*[@id="verification-wrapper"]/i').click()
